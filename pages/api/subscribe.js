export default async function handler(req, res) {
  ...
  try {
    ...
    const createResponse = await fetch(`https://api.convertkit.com/v4/subscribers`, {
      method: "POST",
      headers: {
    ...
    const formRes = await fetch(`https://api.kit.com/v4/forms/${process.env.CONVERTKIT_FORM_ID}/subscribers`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "X-Kit-Api-Key": process.env.CONVERTKIT_API_KEY,
